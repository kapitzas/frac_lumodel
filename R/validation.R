...
ln <- neighbourhood(lu, c(1:K), weights, mask, fun = sum, enr = TRUE)
...
saveRDS(lu_ts, file = "preds_fully_naive.rds")
...
saveRDS(lu_ts, file = "preds_semi_naive.rds")
...
saveRDS(lu_ts, file = "preds_full.rds")
